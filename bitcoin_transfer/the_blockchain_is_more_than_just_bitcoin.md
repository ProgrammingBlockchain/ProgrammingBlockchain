## “블록체인은 단순한 비트 코인 이상입니다” {#the-blockchain-is-more-than-just-bitcoin}
...
이 책의 나머지 부분에서는 이러한 모든 기술과 그 이상을 가능하게 하는 데 필요한 기본 사항을 살펴볼 것입니다. 모든 것은 비트 코인을 사용하는 것으로 시작됩니다.