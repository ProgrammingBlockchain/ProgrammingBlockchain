...
The Base58Check encoding of an address also make sure that a user of a bitcoin wallet don't send money to an address that should be used in a different network.
